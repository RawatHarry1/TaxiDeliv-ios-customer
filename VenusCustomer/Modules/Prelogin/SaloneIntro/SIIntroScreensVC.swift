...
class SIIntroScreensVC: VCBaseVC {
    ...
    override func initialSetup() {
        VCUserDefaults.save(value: true, forKey: .showIntroScreens)
...
//        self.navigationController?.pushViewController(VDWelcomeVC.create(), animated: true)
    ...
    func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        let currentIndex:CGFloat = introCollectionView.contentOffset.x / introCollectionView.frame.size.width
    ...
    @IBAction func nextBtn(_ sender: UIButton) {
        ...
        if currentIndex == 2 {
            ...
            if #available(iOS 13.0, *) {
                ...
                let topPadding = 50
                let bottomPadding = window?.superview?.bottom
