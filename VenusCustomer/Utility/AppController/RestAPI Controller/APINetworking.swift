...
//        let languageCode = TDLanguage(rawValue: languageKey)?.apiCode ?? TDLanguage.english.apiCode
        ...
        updatedHeaders["deviceToken"] = VCUserDefaults.value(forKey: .deviceToken).stringValue
        updatedHeaders["loginType"] = "0"
...
extension AppNetworking {
    ...
    static func showLoader() {
        ...
        NVActivityIndicatorView.DEFAULT_COLOR = VCColors.buttonSelectedOrange.color
